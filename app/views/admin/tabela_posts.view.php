...
<body>
   ...
   <div id="modal-visualizar">
       ...
       <img id="view-imagem" src="" alt="Imagem do Post" style="max-width: 100%; border-radius: 10px; margin-bottom: 10px; min-height: 200px; background-color: #f0f0f0;">
        ...
        <p><strong>Descrição:</strong> <span id="view-descricao" style="word-break: break-word;"></span></p>
    ...
    <div id="modal-criar">
        ...
        <form class="modal-form" method="POST" action="/crudPosts/create">
            ...
            <div class="form-group">
                ...
                <input type="text" id="criar-autor" name="author" required />
            </div>
            ...
            <div class="form-group">
                <label for="criar-imagem">URL da Imagem:</label>
                <input type="text" id="criar-imagem" name="image" required />
            </div>
            </form>
        <p id="modal-criar-erro" class="modal-erro"></p>
        <div class="modal-buttons">
            <button type="button" id="btn-submit-criar" class="btn-salvar">Criar</button>
